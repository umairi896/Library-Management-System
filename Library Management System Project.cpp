...
int main()
{
	...
	while (1)
    {
		...
		cout << "\t\t| PROJECT NAME: LIBRARY MANAGEMENT SYSTEM  |\n";
		...
		cout << "\t|\tProgrammed by : Umair Aziz\t\t\t         |\n";
		
		cout << "\t|\tReg No :        20-CP-47\t\t\t         |\n";
		
		cout << "\t|\tSubmitted To :  Sir Sherhryar \t\t\t         |\n";
...
void display(void)
{
	...
	cout<<"__________"<<"__________________________________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<"__________________"<<endl;
	cout<<setw(10)<<"\"Book ID\""<<setw(25)<<"\"Book Name\""<<setw(23)<<"\"Author Name\""<<setw(23)<<"\"Category\""<<setw(30)<<"\"Publication Company\""<<setw(28)<<"\"Month of Publication\""<<setw(28)<<"\"Year of Publication\""<<endl;
	cout<<"__________"<<"__________________________________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<"__________________"<<endl;
	for(int i=0;i<n;i++)
	{
		cout<<setw(10)<<books[i].bookid<<setw(24)<<books[i].bookname<<setw(22)<<books[i].authorname<<setw(23)<<books[i].bookcategory<<setw(29)<<books[i].bookpubcom<<setw(27)<<books[i].bookpubmonth<<setw(27)<<books[i].bookpubyear<<endl;
		cout<<"__________"<<"__________________________________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<"__________________"<<endl;
	}
...
void sbyname(void)
{
	...
	for(int i = 0;i<n;i++)
	{
		if(strcmp(books[i].bookname,name)==0)
		{
	        ...
	        cout<<setw(10)<<"\"Book ID\""<<setw(25)<<"\"Book Name\""<<setw(23)<<"\"Author Name\""<<setw(23)<<"\"Category\""<<setw(30)<<"\"Publication Company\""<<setw(28)<<"\"Month of Publication\""<<setw(28)<<"\"Year of Publication\""<<endl;
	        cout<<"__________"<<"__________________________________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<"__________________"<<endl;
			cout<<setw(10)<<books[loc].bookid<<setw(24)<<books[loc].bookname<<setw(22)<<books[loc].authorname<<setw(23)<<books[loc].bookcategory<<setw(30)<<books[loc].bookpubcom<<setw(28)<<books[loc].bookpubmonth<<setw(28)<<books[loc].bookpubyear<<endl;
			cout<<"__________"<<"__________________________________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<"__________________"<<endl;	
		}
	}
	if(found == 0)
